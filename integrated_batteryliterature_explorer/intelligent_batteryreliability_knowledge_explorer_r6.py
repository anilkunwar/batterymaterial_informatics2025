...
JSON:"""
    ...
    def get_explanation(self, params, original_text):
        """
        Generates a Markdown explanation of the parsed parameters 
        to show the user what the system understood.
        """
        lines = []
        lines.append("### 📋 Parsed Parameters from Query")
        lines.append("")
        ...
        for key, val in params.items():
            ...
            if isinstance(val, list):
                # Join lists and truncate if too long
            ...
            # Determine status: Did we change it from default?
