# Materials Informatics Approach to Study Solid Mechanics of Lithium Ion Battery
...
[![machinelearningbatterytensormechanics](https://img.shields.io/badge/batteryintelligentstandalonener6-streamlit-red)](https://intelligent-batteryreliabilityner6.streamlit.app/) (memory optimization for cloud computation, utilizes psutil and accelerate modules, ner analysis directly starts from data inspection but the terms category and kknowledge graph tabs are also present)
...
[![machinelearningbatterytensormechanics](https://img.shields.io/badge/batteryexplorer6gpt-streamlit-red)](https://intelligentbatteryexplorer6-gpt.streamlit.app/) (LLM provides the instruction to knowledge graph, influenced knowledgegraph is robust, theoretical explanation, more robustness)
...
[![machinelearningbatterytensormechanics](https://img.shields.io/badge/batteryexplorer8gpt-streamlit-red)](https://intelligentbatteryexplorer8-gpt.streamlit.app/) (Use this model for the analysis as it is more functional that later models too, LLM provides the instruction to knowledge graph, influenced knowledgegraph is robust, theoretical explanation, more robustness, CPU friendly interface design, Use of pyvis for Knowledge Graph visualization)
...
[![machinelearningbatterytensormechanics](https://img.shields.io/badge/batteryknowledgegpt4-streamlit-red)](https://batteryreliabilitygpt4.streamlit.app/) (automated gpt interface to knowledge graph r2 + incorporating physics based rules to graph analysis, LLM gives descriptive answer but cannot relate with graphs and database)
