...
def main():
    ...
    if use_reconstruction and results_orig is not None and results_inf is not None:
        ...
        # ---- NEW ANALYTICS TABS: Current Level of Detachment ----
        ...
        with tab2:
            ...
            with col_left:
                # FIX: Manual calculation of average degree to resolve AttributeError
            ...
            if analysis_type == "Pathway Analysis":
                ...
                for p_orig in path_orig:
                    ...
                    if p_inf:
                        ...
                        delta = len_orig - len_inf # positive means influenced is shorter
                        path_comp.append({
                            "Path": name,
        ...
        # Standard display if not in reconstruction mode
        if results_orig is not None:
